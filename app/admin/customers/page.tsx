  ...
  return (
    <main className="flex-1 p-12 overflow-y-auto">
      <div className="mb-8 flex items-end justify-between">
        <div>
          <h1 className="text-4xl font-black text-blue-900 tracking-tight mb-2 uppercase">Customer Management</h1>
          <p className="text-blue-700/60 font-bold uppercase tracking-widest text-[10px]">Manage laundry customers, subscriptions, and status.</p>
        </div>
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-blue-100/50 border border-white overflow-hidden">
        ...
        {loading ? (
          <div className="p-20 flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-[10px] font-black text-blue-300 uppercase tracking-widest animate-pulse">Fetching Customers...</p>
          </div>
        ) : error ? (
          ...
          <div className="p-20 text-center">
            ...
            <p className="text-sm font-bold text-blue-300 uppercase tracking-widest">No customers match your filter.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-8 py-5 text-[10px] font-black text-blue-300 uppercase tracking-[0.2em]">Customer Info</th>
                    ...
                    <tr key={item._id} className="group hover:bg-slate-50/30 transition-colors">
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className="h-12 w-12 rounded-2xl bg-sky-50 text-sky-600 flex items-center justify-center font-black text-lg border border-sky-100 group-hover:bg-white group-hover:scale-110 transition-all">
