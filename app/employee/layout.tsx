...
import { Map, Users, List, Bike, Shield, HardHat, MapPin, LogOut, Menu, X } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 font-sans text-blue-900">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-blue-50 bg-white shadow-sm">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push('/employee')}>
            ...
            <h2 className="text-xl font-black text-blue-900 tracking-tight uppercase hidden md:block">Laundry Employee</h2>
          </div>
      ...
      <main className="flex-1 w-full bg-grid-pattern py-8">
